                        ...
                        <div class="share-box-inner">
                            ...
                            <div class="share-content-box w-100">
                                <form class="share-text-box">
                                    ...
                                    <button class="btn-share" type="button" data-toggle="modal"  data-target="#textbox">share</button>
                                </form>
                            </div>
                                                ...
                                                <form action="editProfile" method="post">
                                                        ...
                                                        <div class="modal-body custom-scroll">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <button type="submit" class="post-share-btn" data-dismiss="modal">Deactivate</button>
                                                            </div>
                                                </form>
                                            </div>
                                        </div>
